...
//		PITerminology.h
//
//	(c) Copyright 1997-2000 Adobe Systems Incorporated.
//	All Rights Reserved.
//
//	Distribution:
//		PUBLIC
...
// NOTE: The following two units are used only by the text code,
// for historical reasons. All other code should use unitDistance
// for any absolute measurement (inches, centimeters, millimeters,
// points). See the CPIxelToUnit and CUnitToPixel classes and
// their use in various code together with GetUnitFloat and
// PutUnitFloat. DO NOT USE THE UNITS BELOW
