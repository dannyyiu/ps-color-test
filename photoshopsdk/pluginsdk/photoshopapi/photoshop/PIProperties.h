...
#define propVRAM_MB					'VRAM'	// This returns the available VRAM in units of 1024*1024.

/**
* Use this property to tell if the current layer is a smart object layer. (Simple)
*/
#define propLayerIsSmart			'liss'

/**
* Use this property to tell if the host application is Hi-DPI aware. (Simple)
*/
